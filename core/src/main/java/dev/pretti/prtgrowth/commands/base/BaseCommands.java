package dev.pretti.prtgrowth.commands.base;

import dev.pretti.prtgrowth.commands.interfaces.ICommand;
import dev.pretti.prtgrowth.commands.interfaces.ICommands;
...
public abstract class BaseCommands extends BaseCommand implements ICommands
{
   ...
   */
  public BaseCommands(String command, String permission)
  {
